...
[0, 0.796638,3.09445,6.83227,12.1446,19.0946,28.2083,39.7859,52.7009,67.1758,84.0781,102.727,123.357,134.042]]#DUNCAN GOT HIS SHIT TOGETHER :D
    ...
    def drag_curve(hi, vi, t):
        ...
        if t<=t_start:
            ...
            my_height = hi
            wanted_vel = calc_vel(my_height)
            cur_signal = (vi-wanted_vel)*signal_to_ADAS_ratio
            deriv_signal = (cur_signal-prev_signal)/(time_step)*signal_to_ADAS_ratio
            deployment = cur_signal*k_p + deriv_signal*k_d
